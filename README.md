...
**quick note** to have dracut-crypt-ssh built into initramfs we would do
```
efibootmgr --create --disk /dev/nvme0n1 --part 1 --label "Gentoo Safe" --loader "\EFI\gentoo\vmlinuz-safe.efi" --unicode "root=ZFS=zentoo/root ro initrd=\EFI\gentoo\initramfs-safe.img rd.neednet=1 ip=single-dhcp"
```
